...
SLA_DIR points to (or wherever you specified at compile time). That is, the
subfolder hierarchy no longer matters, you could point SLA_DIR to whichever top
level folder ghidra stores its .sla files to and SLA_LOCATION will be able to
search and find the correct .sla file.
